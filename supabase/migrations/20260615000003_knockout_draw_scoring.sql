...
--   Game NOT a draw (direct win)               = 0 pts
--
-- KNOCKOUT — Direct win predicted path (unchanged):
--   Exact score + team wins 90 min             = 5 pts
--   Wrong score + team wins 90 min             = 2 pts
--   Game goes to penalties OR wrong team       = 0 pts
--
  ...
  LOOP
    ...
    IF v_is_knockout THEN
      ...
      IF rec.predicted_winner = 'draw' THEN
        ...
        IF v_actual_90min_winner = 'draw' THEN
          ...
          IF rec.predicted_penalty_winner = v_penalty_winner THEN
            ...
            END IF;
          ELSE
            -- Wrong penalty winner — score doesn't matter
            v_points := 2;
          END IF;
        ELSE
          -- Game was NOT a draw
      ...
      ELSE
        ...
        IF v_actual_90min_winner = 'draw' THEN
          -- Game went to penalties — direct win prediction = 0 pts
          v_points := 0;
        ELSE
